...
//         <TeamsNav />
//       </div>
//       <h1 className="text-center text-white text-5xl font-bold mb-14">Executive Board</h1>
...
//                 <div key={memberIndex} className="w-full sm:w-1/2 lg:w-1/4 flex justify-center mb-10">
//                   <Board
//                     name={member.name}
...
function ExecutiveBoard() {
  ...
  return (
    <div className="min-h-scree">
      ...
      <h1 className="text-center bg-heading-bg text-transparent bg-clip-text text-5xl font-bold mb-14">Executive Board</h1>
      <div className="container mx-auto px-4">
        {Object.entries(groupedByPosition).map(([position, members], posIndex) => (
          <div key={posIndex} className="mb-14">
